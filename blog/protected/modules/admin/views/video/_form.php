<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="widget">
		...
		<div class="widgetcontent">
        	...
        	<?php echo $form->textFieldRow($model, 'url_youtube',array('class'=>'span8')); ?>
			...
			foreach ($modelDesc as $key => $value) {
			    ...
			    echo $form->textArea($value,'['.$lang->code.']content',array('class'=>'span8'));
			    ?>
			    <span class="pj-multilang-input"><img src="<?php echo Yii::app()->baseUrl.'/asset/backend/language/'.$lang->code.'.png' ?>"></span>
			    <span class="help-inline _em_" style="display: none;">Please correct the error</span>
				</div>
			...
			*/ ?>
			...
			<?php echo Common::createFormDatePick('Date Input', 'Date', 'date', $model->date) ?>
			
			<?php echo $form->textFieldRow($model,'sort',array('class'=>'input-block-level', 'placeholder'=>'Masukkan urutan, akan di urutkan dari kecil ke besar')); ?>
