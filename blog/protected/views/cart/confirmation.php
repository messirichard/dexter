    ...
    <div class="prelatife container">
		...
		<div class="inside-content">
			...
			<div class="m-ins-content detail-shopcart content-text">
				...
				<p>Thank you so much for placing an order with us here at DV Computers! <br>
				We will send out a confirmation email of your order as soon as your payment is confirmed.<br>

				Shipping notification of your order will be emailed to you within the next working day.</p>
				...
				<p>
					...
					<div class="right box-finish-shop"><a href="<?php echo CHtml::normalizeUrl(array('/member/index')); ?>" class="btn btn-primary">My Account</a></div>
