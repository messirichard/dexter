                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 descriptions-product adcart">
                            <div class="padding-left-10 padding-right-20">
                                ...
                                <div class="price"><?php echo Cart::money($cart['price']) ?></div>
                                <div class="clear height-25"></div>
                                <div class="row list-button-addcart">
                                    <div class="col-md-4">
                                        <a href="<?php echo CHtml::normalizeUrl(array('/cart/shop')); ?>" class="view-cart back-btn-primary-blue">View Cart</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="<?php echo CHtml::normalizeUrl(array('/product/index')); ?>" class="view-cart back-btn-primary-blue">Continue Shopping</a>
                                    </div>
                                    <div class="col-md-4">
                                        <a href="<?php echo CHtml::normalizeUrl(array('/cart/shop')); ?>" class="view-cart back-btn-primary-gold">Finish Shopping</a>
                                    </div>
                                </div>
                                <div class="clear"></div>
                            </div>
