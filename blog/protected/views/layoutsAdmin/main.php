        ...
        <div class="headerinner">
            <ul class="headmenu">
                <?php if ($login_admin['type'] != 'gerai'): ?>
                    <li><a class="dropdown-toggle"  href="<?php echo CHtml::normalizeUrl(array('/admin/administrator/index')); ?>">
                        <span class="head-icon fa fa-user"></span>
                ...
                <?php if ($login_admin['type'] == 'gerai'): ?>
                    <li><a class="dropdown-toggle"  href="<?php echo CHtml::normalizeUrl(array('/admin/administrator/index')); ?>">
                        <span class="head-icon fa fa-user"></span>
                        <span class="headmenu-label"><?php echo Tt::t('admin', 'Gerai') ?></span>
                    </a></li>
                <?php endif ?>
                ...
                */ ?>
                <?php /*
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/order/index')); ?>">
                ...
                <li >
                    <a class="dropdown-toggle" href="<?php echo CHtml::normalizeUrl(array('/admin/customer/index')); ?>">
                    <span class="head-icon fa fa-group"></span>
                    <span class="headmenu-label"><?php echo Tt::t('admin', 'Customers') ?></span>
                    </a>
                </li>
                    ...
                    <div class="userloggedinfo">
                        ...
                        */ ?>
                        <div class="userinfo">
                            ...
                            <ul>
                                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/home/logout')); ?>"><?php echo Tt::t('admin', 'Logout') ?></a></li>
                                <?php /*
