    ...
    <div class="prelatife container">
        ...
        <div class="prelatife product-list-warp">
            <div class="box-featured-latestproduct" id="cart-shop">
                <div class="box-title">
                    <div class="titlebox-featured" alt="title-product">Login/Register</div>
                    <div class="clear"></div>
                </div>
		...
		'validateOnSubmit'=>false,
					...
					<div class="box-account-history">
					    ...
					    <div class="form-group">
						    ...
						    <div class="col-sm-4">
						    	<button type="submit" class="button-border-black">LOGIN</button>
						    </div>
					    </div>
						 ...
						 <div class="basic-information form-horizontal">
						 	...
						 	<div class="clear height-25"></div>
							    ...
							    <div class="form-group">
								    <label class="col-sm-4 control-label" for="input"></label>
								    <div class="col-sm-5">
								    	<button type="submit" class="btn back-btn-primary-gold">SIGN UP</button>
								    </div>
							    </div>
